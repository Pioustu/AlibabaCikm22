...
tensorboard_path = '/home/featurize/cikm22/exp/tensorboard_logs/doublegann4_2/score'
config_path = './config/double_gnn2.yaml'
client_model_save_path = '/home/featurize/cikm22/result/doublegann4_2/'
client_tensorboard_path = '/home/featurize/cikm22/exp/tensorboard_logs/doublegann4_2/'
...
if __name__ == '__main__':
    ...
    global_bn_opt = torch.optim.Adamax(global_bn.parameters(),lr=0.001)
    ...
    for round in range(ROUND):
        ...
        for e in range(EPOCH):
            ...
            for j, client in enumerate(all_client):
                client.update(encoder=True,gnn=False,ggnn=True,pgnn=False,linear=False,glinear=True,plinear=True,clf=True,stage='is',kd=False)
